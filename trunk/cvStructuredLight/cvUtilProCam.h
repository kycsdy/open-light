...
#ifndef CV_UTIL_PRO_CAM_H_
#define CV_UTIL_PRO_CAM_H_
...
int camPreview(CVCamera* camera, struct slParams* sl_params, struct slCalib* sl_calib);
...
int savePointsOBJ(char* filename, CvMat* points, CvMat* normals, CvMat* colors, CvMat* mask);
